...
namespace TheSurvivorsOfCsharp.Helpers
{
    static class ComputeStatistics
    {
        public static double ComputeAverageGrouped(int[] xs)
        {
            int sum = 0;
            sum += xs[0] * 1;
            sum += xs[1] * 2;
        ...
        public static List<int> ComputeMostCommonGrouped(int[] xs)
        {
        ...
        public static int ComputeMedianGrouped(int[] xs)
        {
            double count = 0;
        ...
        public static double ComputeVarianceGrouped(int[] xs)
        {
        ...
        public static int[] GroupHours(List<int> singleRatings)
        {
            int[] groupedRatings = new int[5];
        ...
        public static int[] GroupGrades(List<int> xs)
        {
            int[] grouped = new int[10];
            foreach(int x in xs)
            {
                grouped[x - 1]++;
            }
